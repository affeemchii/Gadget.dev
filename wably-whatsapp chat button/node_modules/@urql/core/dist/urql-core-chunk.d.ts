import { GraphQLError, DocumentNode, ValueNode, TypeNode, Kind, DirectiveNode } from '@0no-co/graphql.web';
...
type GraphQLRequestParams<Data = any, Variables extends AnyVariables = AnyVariables> = ({
    ...
    [P in keyof Variables]: undefined extends Variables[P] ? unknown : null extends Variables[P] ? unknown : void extends Variables[P] ? unknown : never;
} ? {
    variables?: Variables;
} : {
    variables: Variables;
...
export { AnyVariables, CacheOutcome, Client, ClientOptions, CombinedError, DebugEvent, DebugEventArg, DebugEventTypes, DocumentInput, ErrorLike, Exchange, ExchangeIO, ExchangeInput, ExecutionResult, FetchBody, FormattedNode, GraphQLRequest, GraphQLRequestParams, IncrementalPayload, Operation, OperationContext, OperationDebugMeta, OperationInstance, OperationResult, OperationResultSource, OperationType, PersistedDocument, PersistedRequestExtensions, RequestExtensions, RequestPolicy, TypedDocumentNode, createClient, makeFetchBody, makeFetchOptions, makeFetchURL };
