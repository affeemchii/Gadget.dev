import { DocumentNode, GraphQLError, DefinitionNode } from '@0no-co/graphql.web';
import { AnyVariables, TypedDocumentNode, Exchange, FetchBody, Operation, ExecutionResult, DocumentInput, RequestExtensions, GraphQLRequest, OperationResult, FormattedNode, OperationType, OperationContext, CombinedError } from './urql-core-chunk.js';
