...
const validateSortByField = (column, fieldMetadataTree) => {
    const sortByField = column.sortByField;
    if (sortByField.includes(".")) {
        throw new Error(`Field path '${sortByField}' on custom column '${column.header}' cannot be a relationship path. Sorting through relationships is not supported.`);
    }
    ...
    if ((0, exports.isRelationshipField)(fieldMetadata)) {
