...
exports.PolarisWCAutoTableBulkActionSelector = exports.MORE_ACTIONS_LABEL = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importStar(require("react"));
const useTableBulkActions_js_1 = require("../../hooks/useTableBulkActions.js");
exports.MORE_ACTIONS_LABEL = "Actions";
...
function NonPromotedActionsDropdown(props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("s-button", { commandFor: menuId, variant: "secondary" }, exports.MORE_ACTIONS_LABEL),
        react_1.default.createElement("s-menu", { id: menuId, accessibilityLabel: exports.MORE_ACTIONS_LABEL }, nonPromotedActions.map((action) => (react_1.default.createElement(NonPromotedActionItem, { key: action.humanizedName, action: action, selectedRows: selectedRows, clearSelection: selection.clearAll, rawRecords: rawRecords, actionModalIds: actionModalIds }))))));
}
