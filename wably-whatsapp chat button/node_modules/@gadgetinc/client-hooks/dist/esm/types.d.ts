 ...
 * }
 */
export type UseFindBy = <GivenOptions extends OptionsType, SchemaT, F extends FindOneFunction<GivenOptions, any, SchemaT, any>, const Options extends F["optionsType"] & ReadOperationOptions>(finder: F, value: string, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions> & {
    select?: LimitToKnownKeys<NonNullable<Options["select"]>, F["selectionType"]>;
}) => ReadHookResult<GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * ```
 */
export type UseFindFirst = <GivenOptions extends OptionsType, SchemaT, F extends FindFirstFunction<GivenOptions, any, SchemaT, any>, const Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findFirst: F;
 ...
 * ```
 */
export type UseFindMany = <GivenOptions extends OptionsType, SchemaT, F extends FindManyFunction<GivenOptions, any, SchemaT, any>, const Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findMany: F;
}, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions> & {
    select?: LimitToKnownKeys<NonNullable<Options["select"]>, F["selectionType"]>;
}) => ReadHookResult<GadgetRecordList<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * ```
 */
export type UseFindOne = <GivenOptions extends OptionsType, SchemaT, F extends FindOneFunction<GivenOptions, any, SchemaT, any>, const Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findOne: F;
}, id: string, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions> & {
    select?: LimitToKnownKeys<NonNullable<Options["select"]>, F["selectionType"]>;
}) => ReadHookResult<GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
 ...
 * ```
 */
export type UseGet = <GivenOptions extends OptionsType, SchemaT, F extends GetFunction<GivenOptions, any, SchemaT, any>, const Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    get: F;
}, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions> & {
    select?: LimitToKnownKeys<NonNullable<Options["select"]>, F["selectionType"]>;
}) => ReadHookResult<GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
 ...
 * ```
 */
export type UseMaybeFindFirst = <GivenOptions extends OptionsType, SchemaT, F extends FindFirstFunction<GivenOptions, any, SchemaT, any>, const Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findFirst: F;
}, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions> & {
    select?: LimitToKnownKeys<NonNullable<Options["select"]>, F["selectionType"]>;
}) => ReadHookResult<null | GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
/**
...
SchemaT, F extends FindOneFunction<GivenOptions, any, SchemaT, any>, const Options extends F["optionsType"] & ReadOperationOptions>(manager: {
    findOne: F;
}, id: string, options?: LimitToKnownKeys<Options, F["optionsType"] & ReadOperationOptions> & {
    select?: LimitToKnownKeys<NonNullable<Options["select"]>, F["selectionType"]>;
}) => ReadHookResult<null | GadgetRecord<Select<Exclude<F["schemaType"], null | undefined>, DefaultSelection<F["selectionType"], Options, F["defaultSelection"]>>>>;
