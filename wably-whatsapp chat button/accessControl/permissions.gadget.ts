 ...
 *
 * View and edit your roles and permissions in the Gadget editor at https://whatsapp-chat-button.gadget.app/edit/settings/permissions
 */
  ...
  roles: {
    "shopify-app-users": {
      ...
      models: {
        buttonClick: {
          read: {
            filter: "accessControl/filters/shopify/buttonClick.gelly",
          },
        },
